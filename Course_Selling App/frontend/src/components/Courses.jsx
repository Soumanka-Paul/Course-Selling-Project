      ...
      >
        ...
        <nav>
          <ul>
            ...
            <li className="mb-4">
              <Link to="/getcourse" className="flex items-center text-blue-500">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {courses.map((course) => (
                ...
                >
                  ...
                  <Link
                    to={`/buy/${course._id}`}
                    className="block text-center bg-orange-500 w-full text-white px-4 py-2 rounded-lg hover:bg-blue-900 duration-300"
                  >
                    Buy Now
                  </Link>
                </div>
